<template>
    <div class="inside_header_background" v-if="pageBanner" :style="{ background: 'linear-gradient(0deg, rgba(150,61,43, 0.8), rgba(150,61,43, 0.8)), url(' + pageBanner.image_url + ') center center no-repeat rgba(150,61,43)' }">
