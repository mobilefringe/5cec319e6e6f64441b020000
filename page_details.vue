    ...
    <div> <!-- without an outer container div this component template will not render -->
        ...
        <transition name="fade">
            <div v-if="dataLoaded" v-cloak>
                <div class="inside_header_background" :style="{ background: 'linear-gradient(0deg, rgba(204, 80, 56, 0.8), rgba(251, 129, 105, 0.8)), url(' + pageBanner.image_url + ') center center no-repeat rgba(204, 80, 56)' }">
