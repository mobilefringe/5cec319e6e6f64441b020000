            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 footer_newsletter">
                    ...
                    <form id="subForm" class="js-cm-form" action="https://www.createsend.com/t/subscribeerror?description=" method="post" data-id="92D4C54F0FEC16E5ADC2B1904DE9ED1A6A5E0FFD6C8E21D135DE3E3150C3B3913FD1A29FE19306EE876FB9300987008E5F0E6EA0EED5850061C3FA90C2A0138E">	
                        ...
                        <input autocomplete="Email" aria-label="Email" class="js-cm-email-input qa-input-email" placeholder="Your Email" id="fieldEmail" maxlength="200" name="cm-ydiudkk-ydiudkk" required="" type="email">
                ...
                <div>
                    <p class="footer_text">
                        <a :href="siteInfo.leasing" target="_blank">Leasing</a> |
                          <router-link to="/pages/redlandsvillage-retailer-hub" exact>Retailer Hub</router-link> |
